# Generated by Django 4.1.5 on 2023-03-16 06:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendance_duration', models.DateTimeField(default=datetime.datetime(2023, 3, 17, 6, 45, 20, 216013, tzinfo=datetime.timezone.utc), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendanceTitle', models.CharField(default='Title', max_length=120)),
                ('location_point_range', models.FloatField(default=100.0, null=True)),
                ('attendance_duration', models.DateTimeField(default=datetime.datetime(2023, 3, 17, 6, 45, 20, 214235, tzinfo=datetime.timezone.utc), null=True)),
                ('longitude', models.FloatField(null=True)),
                ('latitude', models.FloatField(null=True)),
                ('datetime_created', models.DateTimeField(auto_now_add=True)),
            ],
