    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendance_duration', models.DateTimeField(default=datetime.datetime(2023, 3, 22, 19, 1, 9, 639631, tzinfo=datetime.timezone.utc), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendanceTitle', models.CharField(default='Title', max_length=120)),
                ('location_point_range', models.FloatField(default=100.0, null=True)),
                ('attendance_duration', models.DateTimeField(default=datetime.datetime(2023, 3, 22, 19, 1, 9, 635615, tzinfo=datetime.timezone.utc), null=True)),
                ('longitude', models.FloatField(null=True)),
                ('latitude', models.FloatField(null=True)),
                ('datetime_created', models.DateTimeField(auto_now_add=True)),
            ],
